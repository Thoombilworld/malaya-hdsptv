...
<section class="grid-12">
  <article class="card col-4 col-md-12">
    ...
    <a class="btn btn-primary" href="<?= hs_admin_content_url('articles.php') ?>">Open Articles</a>
  </article>

  <article class="card col-4 col-md-12">
    <h2>Categories</h2>
    <p class="muted">Manage category hierarchy, visibility, and taxonomy structure.</p>
    <a class="btn btn-secondary" href="<?= hs_admin_content_url('categories.php') ?>">Open Categories</a>
  </article>

  <article class="card col-4 col-md-12">
    <h2>Tags</h2>
    <p class="muted">Control topic tags for SEO, discovery and internal linking.</p>
    <a class="btn btn-secondary" href="<?= hs_admin_content_url('tags.php') ?>">Open Tags</a>
  </article>
</section>
